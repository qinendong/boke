        ...
        <div class="navContainer" v-if="navStatus">
            ...
            <div class="markContainer">
                <ul class="markListGroup">
                    ...
                    <li class="markListItem" @click="addCode"><i class="fa fa-code" aria-hidden="true"></i></li><!--代码-->
                    <li class="markListItem" @click="addLink"><i class="fa fa-link" aria-hidden="true"></i></li><!--链接-->
                    <li class="markListItem" @click="addImage"><i class="fa fa-picture-o" aria-hidden="true"></i></li><!--图片-->
                    <li class="markListItem" @click="addTable" title="table"><i class="fa fa-table" aria-hidden="true"></i></li><!--表格-->
                    <li class="markListItem" @click="addUl" title="ul-list"><i class="fa fa-list-ul" aria-hidden="true"></i></li><!--有序列表-->
                    <li class="markListItem" @click="addOl" title="ol-list"><i class="fa fa-list-ol" aria-hidden="true"></i></li><!--无序列表-->
                    <li class="markListItem" @click="fullPageFn" title="fullpage"><i class="fa fa-arrows-alt" aria-hidden="true"></i></li><!--全屏显示-->
...
<el-dialog title="选择图片" :visible.sync="dialogVisible" width="50%">
         ...
         <el-form id="importModel" enctype="multipart/form-data">
           <el-form-item label="文章封面图">
            <el-input type="file" name="imgUploader" multiple v-model="typefile" id="file"/>
                <el-button type="primary" @click="shangchuan">确定</el-button>
                <p>{{imageurl}}</p>
       </el-form-item>
            </el-form>   
  </el-tab-pane>
  <el-tab-pane label="网络图片">
       <el-input v-model="i_url" autocomplete="off" placeholder="请输入图片所在网址"></el-input>
       <el-button type="primary" @click="wltu">确定</el-button>
  </el-tab-pane>
  ...
  import Vue from 'vue'
    ...
    export default {
        ...
        success:((res)=>{
            console.log(res)
            this.imageurl = res
            let str =`![图片名](${this.imageurl})`
                 console.log("地址"+str)
                 insertContent(str, this);
        })
    });
            ...
            wltu(){
                if(this.i_url){
                    insertContent(`![图片名](${this.i_url})`, this);
                }else{
