<template>
   <el-col :span="20" class="box">
    ...
    <el-form-item label="教程标题">
     <el-input v-model="title" autocomplete="off" placeholder="请输入教程标题"></el-input>
    </el-form-item>
     <el-form-item label="教程简介">
     <el-input v-model="meta_description" autocomplete="off" placeholder="请输入教程简介"></el-input>
    </el-form-item>
...
<script>
    ...
    import {m_post_add} from '~/api/api.js'
    export default {
        ...
        this.$notify({
          ...
          message: h('i', { style: 'color: teal'}, '此新增文章功能不支持修改，修改青岛文章列表进行修改')
                ...
                this.$router.push({path:'/manage/jiaocheng'})
            },
            shangchuan(){
            //alert(1);
